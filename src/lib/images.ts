...
export const heroBackgrounds: Record<PortfolioMode, string> = {
  game: "https://images.unsplash.com/photo-1759661881353-5b9cc55e1cf4?w=1600&h=900&fit=crop&auto=format",
  voice:
    "https://images.unsplash.com/photo-1531651008558-ed1740375b39?w=1600&h=900&fit=crop&auto=format",
};

export const aboutImages: Record<PortfolioMode, string> = {
  game: "https://images.unsplash.com/photo-1759661881353-5b9cc55e1cf4?w=600&h=700&fit=crop&auto=format",
  voice:
    "https://images.unsplash.com/photo-1476136236990-838240be4859?w=600&h=700&fit=crop&auto=format",
};

export const projectImages: Record<PortfolioMode, string[]> = {
  game: [
